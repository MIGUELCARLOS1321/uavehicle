...
import './ForFaculties.css';

const pb = new PocketBase('http://127.0.0.1:8090');

function ForFaculties() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await pb.collection('pickanddropinformation').create(data);
