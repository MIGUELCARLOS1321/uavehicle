        ...
        <div className='pageContainer'>
            ...
            <div className='rightContent'>
                <div className='topSection'>
                    <div className='headerText'>Pick-up and Drop</div>
                </div>
                <div className='midSection'>
                    {currentStep === 1 && (
                        <div>
                            <center>
                                I am applying for a vehicle pass to enter the premises of the University of the Assumption to DROP and PICK my child / pupil / student. In consideration of the University approving my application, I undertake to comply with the following guidelines of the University:
                            </center>
                            <br/>
                            ...
                            <br/>
                            6. For Students, the “One Vehicle Pass, One Student” policy shall be imposed.
                            <br/>
                            7. For motorcycle riders, the “No HELMET, No Entrance” policy shall be strictly enforced.
                            <br/>
                            <br/>
